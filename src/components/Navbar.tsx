        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3 hover-lift">
              ...
              <span className="text-2xl font-[Poppins-Bold] text-gradient-primary">EduTrack</span>
            </div>
            <Badge 
              variant={userType === 'student' ? 'default' : 'secondary'} 
              className="ml-2 px-3 py-1 font-[Poppins-Light]  text-sm  shadow-soft hover:shadow-medium transition-all duration-300"
            >
          ...
          {/* User Section */}
          <div className="flex items-center font-[Poppins-Light] gap-6">
            ...
            >
              {isOnline ? (
                <>
                  ...
                  <span className="text-sm font-[Poppins-Light] text-success">Online</span>
                </>
              ) : (
                <>
                  ...
                  <span className="text-sm font-[Poppins-Light] text-warning">Offline</span>
                </>
              )}
            </Button>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-64 p-2 bg-card/95 backdrop-blur-md border border-border/50 shadow-large rounded-xl">
                <DropdownMenuItem className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-muted/50 transition-all duration-200 cursor-pointer">
                  ...
                  <span className="font-[Poppins-Light]">Profile</span>
                </DropdownMenuItem>
                <DropdownMenuItem className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-muted/50 transition-all duration-200 cursor-pointer">
                  <div className="p-2 bg-accent/10 rounded-lg">
                    <Settings className="h-4 w-4 text-accent" />
                  </div>
                  <span className="font-[Poppins-Light]">Settings</span>
                </DropdownMenuItem>
                ...
                >
                  ...
                  <span className="font-[Poppins-Light]">Logout</span>
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
